...
if( isset($_POST['compatibleEnPourCentUpdate']) and !empty($_POST['compatibleEnPourCentUpdate'])){
  ...
  exit('Modification de compatibilité, Echec de la redirection.');
}

if( isset($pageDisplay) && $pageDisplay == true ){

  $compatibiliteList = [];
  $query = "SELECT * FROM `compatibilite` WHERE id = ".$_GET['id-compatibility']." ORDER BY `compatibilite`.`date_at` DESC";
 ...
 ?>
   ...
   <div class="container-fluid">
     <div class="row justify-content-center">
       ...
       <div class="col-8">
         <h6 data-toggle="collapse"><?= $composantList2D['model1'] ?></h6>
         <h6 data-toggle="collapse" style="padding-bottom:30px;"><?= $composantList2D['model2'] ?></h6>
       </div>
     </div>
   </div>
 <div class="container-fluid">
